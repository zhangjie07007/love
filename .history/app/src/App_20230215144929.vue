...
2019年09月15日。即中秋节阴历八月十五。在一起。  
已有 \`${getDateDiff((new Date()).getFullYear()+'-'+((new Date()).getMonth()+1)+'-'+(new Date()).getDate(),'2018-09-15') + 1}\` 天
...
> 【No one but you × I have my dear Qinxuan】  
        ...
        progressivelyShowStyle(n) {
            return new Promise((resolve, reject) => {
                ...
                let showStyle = (async function() {
                    ...
                    console.log(n, this.currentStyle.length)
                    ...
                    if (this.currentStyle.length < length) {
                        ...
                        if (style.substring(l - 1, l) === '\n' && this.$refs.styleEditor) {
                            this.$nextTick(() => {
                                ...
                                if (n === 2) {
                                    if (n = 2 && this.currentStyle.length > 1800 ) {
                                    this.$refs.resumeEditor.goBottom()
                                } else if (n = 2 && this.currentStyle.length === 2024 ) {
                                    setTimeout(() => {
